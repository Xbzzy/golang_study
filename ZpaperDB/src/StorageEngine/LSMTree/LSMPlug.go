...
// 4.skip list define to keep the choosability of memory table.
// 5.disk block cache to improve the efficiency of read.
// 6.memory management to optimize the memory space(Arena memory pool).
import (
	"bytes"
	"errors"
	"math"
